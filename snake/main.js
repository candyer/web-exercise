...
let step = 20;
let [fx, fy] = Food();
let eatSound = new Audio('sound/eat4.wav');
let lostSound = new Audio('sound/lost2.wav');
let intervalId;
let interval;
...
// make sure only one direction changed during one function call
let lastKey;
...
function changeDirection(e) {
	//press the arrow key to move snake
	if (dirX == 0 && dirY == 0) {
...
document.onkeydown = newDirection;

// if snake head has the same coordinate as food's, the food is eaten by snake. 
// snake body add 1 unit of length.
function eat() {
